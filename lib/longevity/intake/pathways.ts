...
export const INTAKE_PATHWAYS: IntakePathwayDefinition[] = [
  {
    ...
    followupQuestionIds: ["male_androgen_exposure_context"],
  },
  {
    ...
    followupQuestionIds: ["acute_trigger_window", "lifestyle_load"],
  },
  {
    ...
    followupQuestionIds: ["female_hormonal_context"],
  },
  {
    ...
    followupQuestionIds: ["scalp_symptom_cluster"],
  },
  {
  ...
  },
  {
    ...
    entryCriteria: [
      (a) => isYes(a.male_androgen_exposure_context),
      (a) => isYes(a.female_hormonal_context),
    ],
    exitCriteria: [(a) => a.male_androgen_exposure_context != null || a.female_hormonal_context != null],
    followupQuestionIds: ["male_androgen_exposure_context", "female_hormonal_context"],
  },
  {
    ...
    exitCriteria: [(a) => a.presentation_pattern != null],
    followupQuestionIds: ["lifestyle_load", "scalp_symptom_cluster", "mechanical_exposures"],
  },
];
